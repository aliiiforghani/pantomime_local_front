...
const MainNavigation = () => {
  ...
  return (
    <header
      className={`shadow-md mb-10 top-0 transition-all duration-200 bg-white ${
    ...
    >
      <nav>
        <ul className=" items-center  flex justify-between py-2 container xl:max-w-screen-xl">
          <li></li>
          <li>
            <Link className="block py-2  hover:text-amber-400" href="/">
              خانه
            </Link>
          </li>
          ...
          {user ? (
            ...
            <li>
              <Link
                className="block py-2 hover:underline hover:text-amber-400"
                href="/auth"
              >
                ورود
              </Link>
